...
1. It’s customary to put describing files that aren’t code into their own “support” package. URDFs typically go into their own subfolder ''urdf/''. (e.g. See the [abb_irb2400_support](https://github.com/ros-industrial/abb/tree/indigo-devel/abb_irb2400_support) package). Add a `urdf` sub-folder to your application support package.
